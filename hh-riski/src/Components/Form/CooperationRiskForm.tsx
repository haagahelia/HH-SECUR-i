...
import { fetchConsortiumType, fetchContractInfo, fetchCooperationHistory, fetchCountries, fetchFunding, fetchHhRole, fetchLiability, fetchOrganizations, fetchOrganizationType } from "../../util/fetchData";
